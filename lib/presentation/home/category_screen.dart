...
import '../../logics/category_cubit/category_cubit.dart';
import '../../logics/category_cubit/category_state.dart';
        ...
        builder: (context, state) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                onTap: () {
                 Navigator.pushNamed(context,RoutesName.categoryProductScreen , arguments: category);
                },
